...
1. `gui/version.py` → `APP_VERSION = "2.0.0"` (autoritativní runtime zdroj — F-09)
...
| `APP_VERSION` | `"2.0.0"` | gui/version.py (single source of truth) |
...
*Soubor aktualizován: 2026-04-19 | Autor: Claude (Anthropic) | Na základě analýzy zdrojového kódu ZeddiHub Tools Desktop v2.0.0*
